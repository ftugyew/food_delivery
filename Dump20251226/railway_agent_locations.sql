...
CREATE TABLE `agent_locations` (
  ...
  CONSTRAINT `fk_agent_locations_agent` FOREIGN KEY (`agent_id`) REFERENCES `agents` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_agent_locations_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2025-12-26 19:33:13
